...
class LtsPlatformEngineCore {
   ...
   */
  isApiDeprecated(apiName: unknown) {
   ...
   */
  checkUpgradeCompatibility(targetVersion: unknown) {
   ...
   */
  async runConfigMigration(fromVersion: unknown, toVersion: unknown) {
