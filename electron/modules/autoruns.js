import { runPowerShellScript, execAsync } from './nativeServices.js';
...
$items | ConvertTo-Json -Compress
  ...
  try {
    ...
    logError('Failed to get startup items from registry:', { error: error.message });
    return [];
  }
}

async function toggleAutorunItem(item) {
  ...
  try {
    ...
    logError('Failed to toggle startup item:', { error: e.message });
    return false;
  }
}
